...
import com.currix.distributed_lovable.intelligence_service.client.AccountClient;
import com.currix.distributed_lovable.intelligence_service.entity.UsageLog;
import com.currix.distributed_lovable.intelligence_service.repository.UsageLogRepository;
    ...
    public void checkDailyTokenUsage() {
        ...
        if(currentUsage >= limit) {
            throw new ResponseStatusException(HttpStatus.TOO_MANY_REQUESTS,
                    "Daily token usage limit reached. Upgrade now");
        }
    }
