...
import com.currix.distributed_lovable.account_service.service.PaymentProcessor;
...
public class StripePaymentProcessor implements PaymentProcessor {
    ...
    public PortalResponse openCustomerPortal() {
        Long userId = authUtil.getCurrUserId();
        String stripeCustomerId = getUser(userId).getStripeCustomerId();
    ...
    private void handleCheckoutSessionCompleted(Session session, Map<String, String> metadata){
        ...
        if (session == null) {
            log.error("Session object is null for checkout.session.completed event");
            return;
        }
    ...
    private void handleCustomerSubscriptionUpdated(Subscription subscription) {
        ...
        if (subscription == null) {
            log.error("Subscription object is null inside customer.subscription.updated event");
            return;
        }
    ...
    private void handleCustomerSubscriptionDeleted(Subscription subscription) {
        ...
        if (subscription == null) {
            log.error("Subscription object was null inside customer.subscription.deleted event");
            return;
        }
